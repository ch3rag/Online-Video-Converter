					...
					<v-card class="ma-0 pa-0 fill-height">
						...
						<v-list two-line v-if="viewMode == 'List'">
							<v-list-item v-for="item in videos" :key="item._id">
								...
								<v-btn icon ripple>
									<v-icon color="grey lighten-1" @click="play(item)">mdi-play</v-icon>
								</v-btn>
								<v-btn icon ripple>
								...
								<v-btn icon ripple>
									<v-icon color="grey lighten-1" @click="initConvert(item)"
										>mdi-refresh</v-icon
									>
								</v-btn>
								<v-btn icon ripple>
									<v-icon color="grey lighten-1" @click="confirmDeleteVideo(item)">
										mdi-delete
									</v-icon>
								</v-btn>
							</v-list-item>
							...
							<v-row>
								...
								>
									<v-img
										...
										width="336px"
									>
										<v-card-title v-text="item.originalName"></v-card-title>
									</v-img>
											...
											<v-col>
												...
												<section v-if="convert.type === 'video'">
													...
													<v-checkbox
														...
														:disabled="
															selectedVideo ? selectedVideo.audioBitrate == 0 : false
														"
													></v-checkbox>
												</section>
												<div>
...
export default {
	...
	data: () => ({
		...
		videoFormats: ['avi', 'mp4', 'flv', 'webm', 'mov'],
